              ...
              <Card>
                <CardHeader className="flex flex-row items-start gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    />
                      <Label htmlFor={`required-${question.id}`}>{question.id}</Label>
                    </div>
                    <Button
                      variant="ghost"
                ...
                <CardContent>
                  ...
                  {question.type === "single" && (
                    <RadioGroup name="question" onChange={(value) => console.log(value)}>
                    {question.options?.map((option, i) => (
                      <div key={i} className="flex items-center space-x-2">
                        <RadioGroupItem value={option} name="question" />
